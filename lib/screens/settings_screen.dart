    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          DropdownButtonFormField(
            value: ['Minimal', 'Vibrant', 'Animated'].contains(_notificationStyle) ? _notificationStyle : 'Minimal',
          ...
          DropdownButtonFormField(
            value: ['Low', 'Medium', 'High'].contains(_notificationFrequency) ? _notificationFrequency : 'Medium',
